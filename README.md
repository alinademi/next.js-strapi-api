# next.js-strapi-api
Attempting on building quick apis with Strapi which so far seems to be an awesome experience. There are some limitations with the tool but mt thought is it can be used on at least my 50% of projects.


Next.js and Strapi simple api.


[Strapi](https://strapi.io/)<br>
[Strapi Docs](https://strapi.io/documentation/v3.x/getting-started/quick-start.html)<br>
[Strapi repo](https://github.com/strapi/strapi)
...
<br>
👏👏📣📣
Shout out to [@ivandoric](https://github.com/ivandoric) for the awesome series.
This is his repository for "Making Websites With Next.js And Strapi" tutorial series. You can [check out the series here](https://watch-learn.com/series/making-websites-nextjs-and-strapi).
